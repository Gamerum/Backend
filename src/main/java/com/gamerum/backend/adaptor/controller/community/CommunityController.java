...
public class CommunityController {
    ...
    @PostMapping
    public ResponseEntity<CommunityGetDTO> createCommunity(@Validated @RequestBody CommunityCreateDTO community) throws IOException {
    ...
    public ResponseEntity<CommunityGetDTO> updateCommunity(@PathVariable Long communityId, @Validated @RequestBody CommunityUpdateDTO communityUpdateDTO) throws IOException {
